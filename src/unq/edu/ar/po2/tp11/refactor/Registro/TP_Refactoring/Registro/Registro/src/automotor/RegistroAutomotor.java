...
public class RegistroAutomotor {
	...
	public Boolean debeRealizarVtv(Vehiculo vehiculo, LocalDate fecha) {
		...
		// s√≥lo realizan vtv los veh√≠culos con m√°s de 1 anio de antiguedad y
		// radicados
		// en 'Buenos Aires'
		return (this.vehiculoNoPolicial(vehiculo) && this.tieneMasDeUnAÒo(vehiculo, fecha)
	...
	public boolean tieneMasDeUnAÒo(Vehiculo vehiculo, LocalDate fecha) {
